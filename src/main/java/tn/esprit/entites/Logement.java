...
public class Logement {
	...
	public String toString() {
		return "Logement [reference=" + reference + ", adresse=" + adresse + ", delegation=" + delegation
				...
				+ ", getReference()=" + getReference() + ", getAdresse()=" + getAdresse() + ", getDeleguation()="
				+ getDeleguation() + ", getGouvernorat()=" + getGouvernorat() + ", getType()=" + getType()
				+ ", getDescription()=" + getDescription() + ", getPrix()=" + getPrix() + ", hashCode()=" + hashCode()
				+ ", getDelegation()=" + getDelegation() + ", getClass()=" + getClass() + ", toString()="
				+ super.toString() + "]";
	}
